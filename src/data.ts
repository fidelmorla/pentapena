...
export const initialState = (): AppState => ({version:1,currentPayer:'manu',rotation:[...rotation],skips:{fidel:1,marco:0,noyi:0,manu:0},deferredPayer:null,revision:0,updatedAt:new Date(0).toISOString(),history:[
