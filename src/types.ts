...
export interface AdjustmentEvent { id:string; type:'adjustment'; action:'add_skip'|'remove_skip'|'change_next'|'manual_payment'|'undo'; participant?:ParticipantId; note?:string; createdAt:string }
export type HistoryEvent = PaymentEvent | SplitEvent | AdjustmentEvent;
export interface Snapshot { currentPayer:ParticipantId; skips:Record<ParticipantId,number>; history:HistoryEvent[] }
export interface AppState extends Snapshot { version:1; rotation:ParticipantId[]; undo?:Snapshot }
