...
export class LocalStorageAdapter implements StorageAdapter {
 load(){try{const raw=localStorage.getItem(KEY);if(!raw)return null;const value=JSON.parse(raw) as AppState;return value.version===1?value:null}catch{return null}}
